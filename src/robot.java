...
*/
    	...
    	float c4 = (float) Math.cos(theta4);
    	
    	float s1 = (float) Math.sin(theta1);
    	float s2 = (float) Math.sin(theta2);
    	float s3 = (float) Math.sin(theta3);
    	float s4 = (float) Math.sin(theta4);
    	
    	float c234 = (float) Math.cos(theta2+theta3+theta4);
    	float s234 = (float) Math.sin(theta2+theta3+theta4);
    	...
    	theta2 = (float) Math.atan2(p2*(d3*c3+d2)-d3*s3*p1,p1*(d3*c3+d2)+d3*s3*p2);
    	theta3 = (float) Math.atan2(Math.sqrt(1-sqr(c3)), c3);
    	theta4 = (float) (Math.atan2(az, ax*c1+ay*s1)-theta2-theta3);
